    ...
    def test_step(self, batch, batch_idx):
        ...
        if self.save_path is not None:
            ...
            if self.save_tpv:
                ...
                save_folder = "{}/sequences/{}/tpv_feats".format(self.save_path, sequence_id)
                save_tpv(tpv_list, save_folder, frame_id)

                tpv_weights = output_dict['tpv_weights']
                save_folder = "{}/sequences/{}/tpv_weights".format(self.save_path, sequence_id)
                save_weights(tpv_weights, save_folder, frame_id)
